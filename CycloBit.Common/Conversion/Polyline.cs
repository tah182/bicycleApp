...
namespace CycloBit.Common.Conversion {
    ...
    public static class GooglePoints {
        ...
        /// </summary>
        /// <param name="encodedPoints">google encoded string</param>
        /// <returns>a collection of LatLngs</returns>
        ...
        /// Encode it
        /// </summary>
        /// <param name="points">LatLng points</param>
        /// <returns>an encoded string according to google specs</returns>
